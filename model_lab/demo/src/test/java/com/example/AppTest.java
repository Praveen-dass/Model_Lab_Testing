...
public class AppTest {
        ...
        public void test1() throws InterruptedException {
                PropertyConfigurator
                                .configure("C:\\Users\\prave\\OneDrive\\Desktop\\model_lab\\demo\\src\\resource.properties");
                ...
                String txt = driver.findElement(By.xpath("/html/body/div[6]/div/div[3]/div[3]/div/div/div[1]/div"))
                                .getText();
        ...
        public void test2() throws InterruptedException {
                ...
                String price = driver
                                .findElement(By.xpath("/html/body/section[2]/div/div/div/div[5]/div/section/div/p[2]"))
                                .getText();
        ...
        public void test3() throws InterruptedException {
                PropertyConfigurator.configure(
                                "C:\\Users\\prave\\OneDrive\\Desktop\\model_lab\\demo\\src\\resource.properties");
                WebDriverManager.chromedriver().setup();
                driver = new ChromeDriver();
                driver.manage().window().maximize();
                driver.get("https://www.puriholidayresort.com/");
                ...
                driver.findElement(By.xpath(
                                "/html/body/footer/section[1]/div/div[1]/div[2]/div/div/div/div/form/div[2]/textarea"))
                                .sendKeys("Excellent");
                driver.findElement(By.xpath(
                                "/html/body/footer/section[1]/div/div[1]/div[2]/div/div/div/div/form/div[3]/input"))
                                .click();
                Thread.sleep(3000);
                driver.quit();
